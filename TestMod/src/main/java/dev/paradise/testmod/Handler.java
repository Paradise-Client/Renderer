package dev.paradise.testmod;

import dev.paradise.renderer.font.FontRenderer;
import dev.paradise.renderer.util.RendererUtils;
import lombok.SneakyThrows;
import dev.paradise.renderer.objfile.ObjFile;
import dev.paradise.renderer.render.OutlineFramebuffer;
import dev.paradise.renderer.render.Renderer2d;
import dev.paradise.renderer.render.Renderer3d;
